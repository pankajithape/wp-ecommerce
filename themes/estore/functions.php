...
function estore_scripts()
{
	...
	// For testimonial part
	wp_enqueue_style('swiper-css', '//cdnjs.cloudflare.com/ajax/libs/Swiper/6.4.8/swiper-bundle.min.css');
	wp_enqueue_style('swiper-font', '//stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css');
	wp_enqueue_style('university_main_styles', get_theme_file_uri('/css/swiper-testimonials.css'));
	...
	wp_enqueue_script('api-custom222-js', '//cdnjs.cloudflare.com/ajax/libs/jquery/3.5.1/jquery.min.js', NULL, '1.0', true);
	wp_enqueue_script('api-custom321-js', '//cdnjs.cloudflare.com/ajax/libs/Swiper/6.4.8/swiper-bundle.min.js', NULL, '1.0', true);
	wp_enqueue_script('university_main_scripts', get_theme_file_uri('/js/testimonial.js'), array('jquery'), '1.0', true);
...
function estore_admin_scripts($hook)
{
	...
	if ($post_type == 'page') {
		...
		// wp_enqueue_script('estore-meta-toggle111', 'https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js');
	}
}
