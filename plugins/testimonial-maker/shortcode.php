					...
					<?php if ( $testimonial_carousel_design == 'template1' ) { ?>
							<div class="testimonial">
								<div class="testimonial-content">
									...
									<p class="testimonial-link"><a href="<?php echo esc_url( $t_website_url ); ?>"><?php echo esc_url( ucwords( $t_website_url ) ); ?></a></p>	
								</div>
							</div>
							...
							<div class="testimonial">
								...
								<div class="testimonial-content">
									<h3 class="testimonial-title"><?php the_title(); ?>
										...
										<small class="testimonial-link"><a href ="<?php echo esc_url( $t_website_url ); ?>"><?php echo esc_url( ucwords( $t_website_url ) ); ?></a></small>
									</h3>
									<div class="description"><?php echo esc_html( ucwords( $t_text ) ); ?></div>
								</div>
							</div>
		...
		jQuery( window ).load(function() {
			jQuery(document).ready(function(){
				jQuery("#testimonial-slider").owlCarousel({
					items: <?php echo esc_js( $testimonial_column_layout ); ?>,
					itemsDesktop:[1000,1],
					itemsDesktopSmall:[990,2],
					itemsTablet:[768,2],
					itemsMobile:[650,1],
					pagination:<?php echo esc_js( $pagination11 ); ?>,
					<?php if ( $carousal_effect != 'none' ) { ?>
					transitionStyle:"<?php echo esc_js( $carousal_effect ); ?>",
					<?php } ?>
					navigationText:[""],
					autoPlay:<?php echo esc_js( $auto_play_carousel ); ?>,
					slideSpeed:1000,
