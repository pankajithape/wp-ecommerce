...
wp_enqueue_style('awl-tml-bootstrap-css', TML_PLUGIN_URL .'css/bootstrap.css');
wp_enqueue_script('awl-tml-bootstrap-js', TML_PLUGIN_URL .'js/bootstrap.js', array('jquery'), '' , true);
wp_enqueue_style('thickbox');
wp_enqueue_style('tml-bootstrap-css', TML_PLUGIN_URL.'featured-plugins/css/bootstrap.css');
wp_enqueue_style('tml-smartech-css', TML_PLUGIN_URL.'featured-plugins/css/smartech.css');
wp_enqueue_style('tml-feature-plugins', TML_PLUGIN_URL.'featured-plugins/css/feature-plugins.css');	
wp_enqueue_script('jquery');
wp_enqueue_script('tml-media-uploads',TML_PLUGIN_URL.'js/featured-plugins/acl-media-upload-script.js',array('media-upload','thickbox','jquery')); 
wp_enqueue_script('tml-bootstrap-min-js',TML_PLUGIN_URL.'js/featured-plugins/bootstrap.min.js');
